...
import { Mail, MailSendModel, MailViewModel } from "../models/mail";
...
export class MailService {
  ...
  send({ from: from, recipient: recipient, subject: subject, hmessage: hmessage, pmessage: pmessage, type: type }: MailSendModel) {
  ...
  getMailById(id: string) {
    ...
    }) as unknown as Bluebird<MailViewModel>;
  }
}
